<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" > <?php echo e($task == 'save' ? 'Add Slider' : 'Edit Slider'); ?> </h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>

        <form class="form-horizontal" action="<?php echo e(url( $task == 'save' ? '/slider/save' : '/slider/update')); ?>" method="post">
...
<!-- /.modal-District -->
<?php /**PATH /var/www/unknown/resources/views/dashboard/pages/modals/add_edit_slider.blade.php ENDPATH**/ ?>