...
<script>
    var bsurl = '<?php echo e(Storage::url('images')); ?>';
    // var bsurl = 'images';
    ...
    $(function () {
        ...
        $("body").on("click", "ul.files_container .fm_file_sel", function() {
            ...
            $("body").find('#image_preview').attr('src','<?php echo e(Storage::url('images')."/"); ?>'+upload).show();
            $('body').find('#image').val('<?php echo e(Storage::url('images')."/"); ?>'+upload);
...
<?php /**PATH /var/www/unknown/resources/views/dashboard/pages/modals/add_media.blade.php ENDPATH**/ ?>