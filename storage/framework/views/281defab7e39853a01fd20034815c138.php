...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo e(url('/post/save')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo e($post->title); ?>" name="title" id="title" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="subtitle">Subtitle</label>
                                    <input type="text" value="<?php echo e($post->subtitle); ?>" name="subtitle" id="subtitle" class="form-control">
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <p ><b>Draft:</b>
                                            <input type="checkbox" name="draft" id="draft" value="1" <?php if($post->draft=='1'): ?> checked <?php endif; ?>>
                                        </p>
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="cont-img"><img id="image_preview"  <?php if(!empty($post)): ?> src="<?php echo e($post->image); ?>" width="200"  <?php else: ?> src="" style="display:none;" width="200" <?php endif; ?>  /></div>
...
<?php echo $__env->make('dashboard.layouts.app',['name' => 'Add Post'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wampp\www\unknown\resources\views/dashboard/pages/modals/add_edit_post.blade.php ENDPATH**/ ?>