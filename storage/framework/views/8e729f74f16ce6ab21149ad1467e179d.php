<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" > <?php echo e($task == 'save' ? 'Add Gallery' : 'Edit Gallery'); ?> </h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>

        <form class="form-horizontal" action="<?php echo e(url( $task == 'save' ? '/gallery/save' : '/gallery/update')); ?>" method="post">
...
<!-- /.modal-District -->
<?php /**PATH D:\wampp\www\unknown\resources\views/dashboard/pages/modals/add_edit_gallery.blade.php ENDPATH**/ ?>