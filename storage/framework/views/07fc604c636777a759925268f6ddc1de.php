<?php $__env->startSection('content'); ?>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo e(url('gallery/images/upload_files')); ?>" id="fm_dropzone_main" enctype="multipart/form-data" method="POST">
                                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function loadUploadedFiles() {
            // load folder files
            url = "<?php echo e(url('/gallery/images/uploaded_files')."/".$gallery->id); ?>";
            $.ajax({
                dataType: 'json',
                url: url,
        ...
        function formatFile(upload,data) {
            var image = '';
            var path = '<?php echo e(url('/')); ?>'+upload.image;
...
<?php echo $__env->make('dashboard.layouts.app',['name' => 'Gallery'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wampp\www\unknown\resources\views/dashboard/pages/modals/add_edit_gallery_images.blade.php ENDPATH**/ ?>